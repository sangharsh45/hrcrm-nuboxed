...
// Cell Tech
const login_url = "https://celltechmarketplace-env.eba-3gxbmdfd.eu-west-3.elasticbeanstalk.com";
const base_url = "https://celltechmarketplace-env.eba-3gxbmdfd.eu-west-3.elasticbeanstalk.com/api/v1";
const base_url2 = "https://develop.tekorero.com/Erp";

const asses_url = "https://develop.tekorero.com/Assessment-0.0.1-SNAPSHOT";

export { base_url, login_url, asses_url, base_url2 };
// http://celltechmarketplace-env.eba-3gxbmdfd.eu-west-3.elasticbeanstalk.com/
