...
export const UPDATE_EMAIL_CREDENTIAL_FAILURE =
  ...
  export const UPDATE_EMAIL_DEFAULT_REQUEST =
  "UPDATE_EMAIL_DEFAULT_REQUEST";
export const UPDATE_EMAIL_DEFAULT_SUCCESS =
  "UPDATE_EMAIL_DEFAULT_SUCCESS";
export const UPDATE_EMAIL_DEFAULT_FAILURE =
  "UPDATE_EMAIL_DEFAULT_FAILURE";
