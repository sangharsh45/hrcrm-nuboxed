...
import { bindActionCreators } from "redux";
 import { shareTaskPermission, getPermissionsListTask,getTaskListRangeByUserId } from "../../Task/TaskAction";
import { StyledSelect } from "../../../Components/UI/Antd";
const Option =StyledSelect;

function EventSharedForm(props) {
...
export default connect(mapStateToProps, mapDispatchToProps)(EventSharedForm);
